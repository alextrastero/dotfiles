...
let s:I2 = [ '#83afe5' , '#32322F' , 3 , 'black' ]
let s:I3 = [ '#83afe5' , '#3c4c55' , 3 , 233 ]
let s:I4 = [ '#83afe5' , 11 ]

" Visual mode
let s:V1 = [ '#141413' , '#f2c38f' , 232 , 4 ]
let s:V2 = [ '#f2c38f' , '#32322F' , 4 , 'black' ]
let s:V3 = [ '#f2c38f' , '#3c4c55' , 4 , 233 ]
let s:V4 = [ '#7CB0E6' , 12 ]

" Replace mode
let s:R1 = [ '#141413' , '#E5786D' , 232 , 1 ]
let s:R2 = [ '#E5786D' , '#32322F' , 1 , 'black' ]
let s:R3 = [ '#E5786D' , '#3c4c55' , 1 , 233 ]
let s:R4 = [ '#E55345' , 9 ]
...
let g:airline#themes#nova#palette.accents = {
      \ 'red': [ '#E5786D' , '' , 203 , '' , '' ],
      \ }

let g:airline#themes#nova#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#nova#palette.normal_modified = {
...
let g:airline#themes#nova#palette.insert_modified = {
...
let g:airline#themes#nova#palette.visual_modified = {
...
let g:airline#themes#nova#palette.replace_modified = {
    \ 'airline_a': [ s:R1[0] , s:R4[0] , s:R1[2] , s:R4[1] , ''     ] ,
    \ 'airline_b': [ s:R4[0] , s:IM[0] , s:R4[1] , s:IM[1] , ''     ] ,
    \ 'airline_c': [ s:R4[0] , s:N3[1] , s:R4[1] , s:N3[3] , ''     ] }


let g:airline#themes#nova#palette.insert_paste = {
    \ 'airline_a': [ s:I1[0] , s:PA[0] , s:I1[2] , s:PA[1] , ''     ] ,
    \ 'airline_b': [ s:PA[0] , s:IM[0] , s:PA[1] , s:IM[1] , ''     ] ,
    \ 'airline_c': [ s:PA[0] , s:N3[1] , s:PA[1] , s:N3[3] , ''     ] }


let g:airline#themes#nova#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
let g:airline#themes#nova#palette.inactive_modified = {
...
let g:airline#themes#nova#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ '#DADADA' , '#3c4c55' , 253 , 234 , ''     ] ,
