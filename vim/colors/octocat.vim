...
if &background == "light"
    hi Boolean gui=NONE guifg=#0083b3 guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=#f5f5f5
    hi Comment gui=NONE guifg=#959795 guibg=NONE
    ...
    hi Normal gui=NONE guifg=#323434 guibg=#ffffff
    hi Number gui=NONE guifg=#0083b3 guibg=NONE
    ...
    hi Special gui=NONE guifg=#61a659 guibg=NONE
